...
public class DeleteHandlerHandlerTest extends AbstractHandlerTestBase {
    ...
    @Test
    public void handleRequest_SimpleSuccess_WithFinalSnapshot() {
        final DeleteTenantDatabaseResponse deleteTenantDatabaseResponse = DeleteTenantDatabaseResponse.builder()
                .tenantDatabase(TENANT_DATABASE)
                .build();

        MethodCallExpectation<DeleteTenantDatabaseRequest, DeleteTenantDatabaseResponse>
                deleteTenantDatabaseCallExpectation = expectDeleteTenantDatabaseCall();
        deleteTenantDatabaseCallExpectation.setup().thenReturn(deleteTenantDatabaseResponse);
        ...
        final ArgumentCaptor<DeleteTenantDatabaseRequest> requestArgumentCaptor = deleteTenantDatabaseCallExpectation.verify();
        Assertions.assertThat(requestArgumentCaptor.getValue().skipFinalSnapshot()).isFalse();
        Assertions.assertThat(requestArgumentCaptor.getValue().finalDBSnapshotIdentifier()).isNotEmpty();
    }

    @Test
    public void handleRequest_SimpleSuccess_SkipFinalSnapshot() {
        final DeleteTenantDatabaseResponse deleteTenantDatabaseResponse = DeleteTenantDatabaseResponse.builder()
                .tenantDatabase(TENANT_DATABASE)
                .build();

        expectDeleteTenantDatabaseCall().setup().thenReturn(deleteTenantDatabaseResponse);
    ...
    public void handleRequest_DeleteTenantDatabase_HandleException(
        ...
        test_handleRequest_error(
                expectDeleteTenantDatabaseCall(),
                new CallbackContext(),
                BASE_RESOURCE_MODEL_BUILDER::build,
                requestException,
                expectResponseCode
    ...
    static class DeleteTenantDatabasesExceptionArgumentsProvider implements ArgumentsProvider {
        @Override
